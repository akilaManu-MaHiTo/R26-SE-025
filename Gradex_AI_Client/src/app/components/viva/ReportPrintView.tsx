  ...
  return (
    <div className="p-10 text-black bg-white text-sm leading-relaxed">
      ...
      <div className="mt-8 pt-3 border-t border-gray-300 text-[10px] text-gray-400">
        ...
        {withTech
          ? "Technical viva — the final score fuses this AI performance score with an examiner-entered technical accuracy score, reviewed and published by the evaluator."
