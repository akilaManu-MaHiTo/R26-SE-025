...
def weakness_from_percentage(average_percentage: float) -> float:
    """Convert 0-100 percentage to 0..1 weakness. 50% -> 0.50."""
    return round(max(0.0, min(1.0, 1.0 - average_percentage / 100.0)), 4)
    ...
    if canonical_topic_performance:
        ...
        for entry in canonical_topic_performance:
            ...
            result[topic] = {
                ...
                "weakness": weakness_from_percentage(pct),
    ...
    try:
        ...
        for cid, pcts in buckets.items():
            ...
            result[topic_name] = {
                ...
                "weakness": weakness_from_percentage(avg_pct),
                "status": status,
                "priority": status,
                "question_count": 0,
