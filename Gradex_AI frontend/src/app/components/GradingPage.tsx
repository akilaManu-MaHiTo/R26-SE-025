            ...
            >
              ...
              {processing && (
                <div className="absolute inset-0 bg-white/75 backdrop-blur-sm flex flex-col items-center justify-center gap-4">
                  <div className="size-14 rounded-full border-4 border-blue-100 border-t-blue-600 animate-spin" />
                  <div className="text-center">
                    <div className="text-sm text-slate-800">
                      {mode === "diagram" ? "Detecting diagram elements…" : "Running OCR extraction…"}
                    </div>
                    <div className="text-xs text-slate-500 mt-1">AI confidence scoring in progress</div>
                  </div>
                  <div className="w-56">
                    <div className="flex justify-between text-xs text-slate-500 mb-1">
                      <span>Progress</span><span>{extractProgress}%</span>
                    </div>
